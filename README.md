...
## 1. Топология и задача

**Цель:** Объединить две локальные сети через незащищенную среду (эмуляция WAN), зашифровав трафик стандартом IPsec, и настроить динамическую маршрутизацию без статических маршрутов.
...
### Принцип работы (Teory of Operation)
...
## 2. Конфигурация R1 (Physical Cisco 3825)
